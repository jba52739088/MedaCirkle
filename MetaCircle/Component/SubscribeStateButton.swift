...
protocol SubscribeStateButtonDelegate {
  func didTap(_ view: SubscribeStateButton)
}

class SubscribeStateButton: UIView {
  ...
  var didSelected: Bool = false {
    didSet {
      self.button.isSelected = didSelected
    }
  }
  var disposeBag = DisposeBag()
  let privacy: CircleCreateViewModel.Privacy
  let delegate: SubscribeStateButtonDelegate?

  init(privacy: CircleCreateViewModel.Privacy, delegate: SubscribeStateButtonDelegate? = nil) {
  ...
  func setupViews() {
    ...
    iconImgView.do {
      ...
      $0.leftToRight(of: button, offset: 8)
      $0.height(25)
      $0.width(25)
...
private
extension SubscribeStateButton {
