...
class RegisterViewModel {
  ...
  var passwordAttributedString: NSAttributedString {
    return R.string.localizable.register_vc_register_password_title()
      .set(style: theme.textFieldTitleTextStyle)
  }
  ...
  var passwordHintAttributedString: NSAttributedString {
    return R.string.localizable.register_vc_password_hint()
      .set(style: theme.passwordHintTextStyle)
  }

  var rePasswordPlaceholderAttributedString: NSAttributedString {
    return R.string.localizable.register_vc_register_re_password_placeholder()
      .set(style: theme.textFieldPlaceholderTextStyle)
  }

  var enableLoginAttributedString: NSAttributedString {
    return R.string.localizable.register_vc_submit_button()
...
extension RegisterViewModel.Theme {
