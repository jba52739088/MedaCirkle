...
protocol CircleContentCellDelegate: AnyObject {
...
class CircleContentCell: CircleContentBaseCell {
    ...
    weak var delegate: CircleContentCellDelegate?
    ...
    override func setup() {
        ...
        readMoreButton.do {
            ...
            $0.leftToSuperview(offset: 10)
            $0.addTarget(self, action: #selector(didReadMoreButton), for: .touchUpInside)
        }
    ...
    @objc func didReadMoreButton() {
        print("didReadMoreButton")
        self.delegate?.didClickReadMore(in: self)
    }
    
    @objc func didTapAwesomeButton() {
        print("didTapAwesomeButton")
        self.delegate?.didClickAwesome(in: self)
    }
    
    @objc func didTapReplyButton() {
        print("didTapReplyButton")
        self.delegate?.didClickReply(in: self)
    }
    
    @objc func didTapBookmarkButton() {
        print("didTapBookmarkButton")
        self.delegate?.didClickBookmark(in: self)
    }
    
    @objc func didTapShareButton() {
        print("didTapShareButton")
        self.delegate?.didClickShare(in: self)
    }
    
    @objc func didTapMenuButton() {
        print("didTapMenuButton")
        self.delegate?.didClickMenu(in: self)
    }
}
